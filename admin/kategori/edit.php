...
define('PAGE_TITLE', 'Edit Kategori');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validateCsrfToken($_POST['csrf_token'] ?? '')) {
        ...
        if (empty($nama)) {
            ...
            query("UPDATE kategori_sarpras SET nama = ?, deskripsi = ? WHERE id = ?", [$nama, $deskripsi, $id]);
            logActivity('UPDATE_KATEGORI', "Updated category: $nama");
        ...
        <form method="POST" action="">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="nama" value="<?= e($_POST['nama'] ?? $kategori['nama']) ?>"
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?= e($_POST['deskripsi'] ?? $kategori['deskripsi']) ?></textarea>
                </div>
            </div>
